 ...
 * @note        None
 */
void UI_Def::Draw_Line(graphic_data_struct_t *Graph,
                       char GraphName[3],
 ...
 * @note        None
 */
void UI_Def::Draw_Rectangle(graphic_data_struct_t *Graph,
                            char GraphName[3],
                            uint8_t GraphOperate,
                            uint8_t Layer,
                            uint8_t Color,
 ...
 * @note        None
 */
void UI_Def::Draw_Circle(graphic_data_struct_t *Graph,
                         char GraphName[3],
                         uint8_t GraphOperate,
                         uint8_t Layer,
                         uint8_t Color,
 ...
 * @note        None
 */
void UI_Def::Draw_Ellipse(graphic_data_struct_t *Graph,
                          char GraphName[3],
                          uint8_t GraphOperate,
                          uint8_t Layer,
                          uint8_t Color,
 ...
 * @note        None
 */
void UI_Def::Draw_Arc(graphic_data_struct_t *Graph,
                      char GraphName[3],
                      uint8_t GraphOperate,
                      uint8_t Layer,
                      uint8_t Color,
 ...
 * @note        None
 */
void UI_Def::Draw_Float(graphic_data_struct_t *Graph,
                        char GraphName[3],
                        uint8_t GraphOperate,
                        uint8_t Layer,
                        uint8_t Color,
 ...
 * @note        None
 */
void UI_Def::Draw_Int(graphic_data_struct_t *Graph,
                      char GraphName[3],
                      uint8_t GraphOperate,
                      uint8_t Layer,
                      uint8_t Color,
 ...
 * @note        None
 */
void UI_Def::Draw_String(string_data_struct_t *String,
                         char StringName[3],
...
void UI_Def::PushUp_Graphs(uint8_t Counter, void *Graphs, uint8_t RobotID)
{
    ...
    Graph->Referee_Transmit_Header.CRC8 = Get_CRC8_Check_Sum((uint8_t *)Graph, CRC8, 0xFF);
    ...
    if (Counter == 1) {
        ...
        Graph1->CRC16 = Get_CRC16_Check_Sum((uint8_t *)Graph1, sizeof(UI_Graph1_t) - 2, 0xFFFF);
    } else if (Counter == 2) {
        UI_Graph2_t *Graph2 = (UI_Graph2_t *)Graphs;
        Graph2->CRC16 = Get_CRC16_Check_Sum((uint8_t *)Graph2, sizeof(UI_Graph2_t) - 2, 0xFFFF);
    } else if (Counter == 5) {
        UI_Graph5_t *Graph5 = (UI_Graph5_t *)Graphs;
        Graph5->CRC16 = Get_CRC16_Check_Sum((uint8_t *)Graph5, sizeof(UI_Graph5_t) - 2, 0xFFFF);
    } else if (Counter == 7) {
        UI_Graph7_t *Graph7 = (UI_Graph7_t *)Graphs;
        Graph7->CRC16 = Get_CRC16_Check_Sum((uint8_t *)Graph7, sizeof(UI_Graph7_t) - 2, 0xFFFF);
    }

    /* 使用串口PushUp到裁判系统 */
    if (Counter == 1)
        UartSendData(&huart6, (uint8_t *)Graph, sizeof(UI_Graph1_t), UART_TRANSMIT_IT);
    else if (Counter == 2)
        UartSendData(&huart6, (uint8_t *)Graph, sizeof(UI_Graph2_t), UART_TRANSMIT_IT);
    else if (Counter == 5)
        UartSendData(&huart6, (uint8_t *)Graph, sizeof(UI_Graph5_t), UART_TRANSMIT_IT);
    else if (Counter == 7)
        UartSendData(&huart6, (uint8_t *)Graph, sizeof(UI_Graph7_t), UART_TRANSMIT_IT);
}
...
void UI_Def::PushUp_String(UI_String_t *String, uint8_t RobotID)
{
    ...
    String->Referee_Transmit_Header.CRC8 = Get_CRC8_Check_Sum((uint8_t *)(&String->Referee_Transmit_Header), CRC8, 0xFF);
    ...
    /* 填充 frame_tail 即CRC16 */
    String->CRC16 = Get_CRC16_Check_Sum((uint8_t *)String, sizeof(UI_String_t) - 2, 0xFFFF);

    /* 使用串口PushUp到裁判系统 */
    UartSendData(&huart6, (uint8_t *)String, sizeof(UI_String_t), UART_TRANSMIT_IT);
}
...
void UI_Def::PushUp_Delete(UI_Delete_t *Delete, uint8_t RobotID)
{
    ...
    Delete->Referee_Transmit_Header.CRC8 = Get_CRC8_Check_Sum((uint8_t *)(&Delete->Referee_Transmit_Header), CRC8, 0xFF);
    ...
    /* 填充 frame_tail 即CRC16 */
    Delete->CRC16 = Get_CRC16_Check_Sum((uint8_t *)Delete, sizeof(UI_Delete_t) - 2, 0xFFFF);

    /* 使用串口PushUp到裁判系统 */
    UartSendData(&huart6, (uint8_t *)Delete, sizeof(UI_Delete_t), UART_TRANSMIT_IT);
}
