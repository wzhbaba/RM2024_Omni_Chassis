...
class UI_Def
{
   public:
    ...
    UI_String_t UI_String[3];
    UI_Delete_t UI_Delete;
    void Draw_Line(graphic_data_struct_t *Graph,
                   char GraphName[3],
                   ...
                   uint16_t EndX,
                   uint16_t EndY);
    void Draw_Rectangle(graphic_data_struct_t *Graph,
                        char GraphName[3],
                        uint8_t GraphOperate,
                        uint8_t Layer,
                        uint8_t Color,
                        ...
                        uint16_t EndX,
                        uint16_t EndY);
    void Draw_Circle(graphic_data_struct_t *Graph,
                     char GraphName[3],
                     uint8_t GraphOperate,
                     uint8_t Layer,
                     uint8_t Color,
                     ...
                     uint16_t CenterY,
                     uint16_t Radius);
    void Draw_Ellipse(graphic_data_struct_t *Graph,
                      char GraphName[3],
                      uint8_t GraphOperate,
                      uint8_t Layer,
                      uint8_t Color,
                      ...
                      uint16_t XHalfAxis,
                      uint16_t YHalfAxis);
    void Draw_Arc(graphic_data_struct_t *Graph,
                  char GraphName[3],
                  uint8_t GraphOperate,
                  uint8_t Layer,
                  uint8_t Color,
                  ...
                  uint16_t XHalfAxis,
                  uint16_t YHalfAxis);
    void Draw_Float(graphic_data_struct_t *Graph,
                    char GraphName[3],
                    uint8_t GraphOperate,
                    uint8_t Layer,
                    uint8_t Color,
                    ...
                    uint16_t StartY,
                    float FloatData);
    void Draw_Int(graphic_data_struct_t *Graph,
                  char GraphName[3],
                  uint8_t GraphOperate,
                  uint8_t Layer,
                  uint8_t Color,
                  ...
                  uint16_t StartY,
                  int32_t IntData);
    void Draw_String(string_data_struct_t *String,
                     char StringName[3],
